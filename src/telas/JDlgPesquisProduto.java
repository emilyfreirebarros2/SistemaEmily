...
public class JDlgPesquisProduto extends javax.swing.JDialog {
    ...
    public JDlgPesquisProduto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgPesquisProduto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgPesquisProduto dialog = new JDlgPesquisProduto(new javax.swing.JFrame(), true);
